...
return [
    ...
    'menus_add_recipes' => 'Add recipes to this shelf',
    'menus_drag_recipes' => 'Drag recipes here to add them to this shelf',
    'menus_empty_contents' => 'This shelf has no recipes assigned to it',
    'menus_edit_and_assign' => 'Edit shelf to assign recipes',
    'menus_edit_named' => 'Edit Recipemenus :name',
    'menus_edit' => 'Edit Recipemenus',
    'menus_delete' => 'Delete Recipemenus',
    'menus_delete_named' => 'Delete Recipemenus :name',
    'menus_delete_explain' => "This will delete the bookshelf with the name ':name'. Contained recipes will not be deleted.",
    'menus_delete_confirmation' => 'Are you sure you want to delete this bookshelf?',
    'menus_permissions' => 'Recipemenus Permissions',
    'menus_permissions_updated' => 'Recipemenus Permissions Updated',
    'menus_permissions_active' => 'Recipemenus Permissions Active',
    'menus_permissions_cascade_warning' => 'Permissions on bookshelves do not automatically cascade to contained recipes. This is because a book can exist on multiple menus. Permissions can however be copied down to child recipes using the option found below.',
    'menus_copy_permissions_to_recipes' => 'Copy Permissions to Books',
    'menus_copy_permissions' => 'Copy Permissions',
    'menus_copy_permissions_explain' => 'This will apply the current permission settings of this bookshelf to all recipes contained within. Before activating, ensure any changes to the permissions of this bookshelf have been saved.',
    'menus_copy_permission_success' => 'Recipemenus permissions copied to :count recipes',
