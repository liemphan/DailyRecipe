...
return [
    ...
    'menu' => 'Shelf',
    'menus' => 'Shelves',
    'x_menus' => ':count Shelf|:count Shelves',
    'menus_long' => 'Bookshelves',
    'menus_empty' => 'No shelves have been created',
    'menus_create' => 'Create New Shelf',
    'menus_popular' => 'Popular Shelves',
    'menus_new' => 'New Shelves',
    'menus_new_action' => 'New Shelf',
    'menus_popular_empty' => 'The most popular shelves will appear here.',
    'menus_new_empty' => 'The most recently created shelves will appear here.',
    'menus_save' => 'Save Shelf',
    'menus_recipes' => 'Books on this shelf',
    'menus_add_recipes' => 'Add books to this shelf',
    'menus_drag_recipes' => 'Drag books here to add them to this shelf',
    'menus_empty_contents' => 'This shelf has no books assigned to it',
    'menus_edit_and_assign' => 'Edit shelf to assign books',
    'menus_edit_named' => 'Edit Bookshelf :name',
    'menus_edit' => 'Edit Bookshelf',
    'menus_delete' => 'Delete Bookshelf',
    'menus_delete_named' => 'Delete Bookshelf :name',
    'menus_delete_explain' => "This will delete the bookshelf with the name ':name'. Contained books will not be deleted.",
    'menus_delete_confirmation' => 'Are you sure you want to delete this bookshelf?',
    'menus_permissions' => 'Bookshelf Permissions',
    'menus_permissions_updated' => 'Bookshelf Permissions Updated',
    'menus_permissions_active' => 'Bookshelf Permissions Active',
    'menus_permissions_cascade_warning' => 'Permissions on bookshelves do not automatically cascade to contained books. This is because a book can exist on multiple shelves. Permissions can however be copied down to child books using the option found below.',
    'menus_copy_permissions_to_recipes' => 'Copy Permissions to Books',
    'menus_copy_permissions' => 'Copy Permissions',
    'menus_copy_permissions_explain' => 'This will apply the current permission settings of this bookshelf to all books contained within. Before activating, ensure any changes to the permissions of this bookshelf have been saved.',
    'menus_copy_permission_success' => 'Bookshelf permissions copied to :count books',
