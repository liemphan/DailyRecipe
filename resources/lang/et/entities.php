...
return [
    ...
    'recently_created_recipes' => 'Hiljuti lisatud raamatud',
    'recently_created_menus' => 'Hiljuti lisatud riiulid',
    ...
    'menu' => 'Riiul',
    'menus' => 'Riiulid',
    'x_menus' => ':count riiul|:count riiulit',
    'menus_long' => 'Raamaturiiulid',
    'menus_empty' => 'Ühtegi riiulit pole lisatud',
    'menus_create' => 'Lisa uus riiul',
    'menus_popular' => 'Populaarsed riiulid',
    'menus_new' => 'Uued riiulid',
    'menus_new_action' => 'Uus riiul',
    'menus_popular_empty' => 'Siia tulevad kõige populaarsemad riiulid.',
    'menus_new_empty' => 'Siia tulevad hiljuti lisatud riiulid.',
    'menus_save' => 'Salvesta riiul',
    'menus_recipes' => 'Raamatud sellel riiulil',
    'menus_add_recipes' => 'Lisa sellele riiulile raamatuid',
    'menus_drag_recipes' => 'Lohista raamatuid siia, et neid sellele riiulile lisada',
    'menus_empty_contents' => 'Sellel riiulil ei ole ühtegi raamatut',
    'menus_edit_and_assign' => 'Muuda riiulit, et siia raamatuid lisada',
    'menus_edit_named' => 'Muuda riiulit :name',
    'menus_edit' => 'Muuda riiulit',
    'menus_delete' => 'Kustuta riiul',
    'menus_delete_named' => 'Kustuta riiul :name',
    'menus_delete_explain' => "See kustutab riiuli nimega ':name'. Raamatuid, mis on sellel riiulil, ei kustutata.",
    'menus_delete_confirmation' => 'Kas oled kindel, et soovid selle raamaturiiuli kustutada?',
    'menus_permissions' => 'Riiuli õigused',
    'menus_permissions_updated' => 'Riiuli õigused muudetud',
    'menus_permissions_active' => 'Riiuli õigused on aktiivsed',
    'menus_permissions_cascade_warning' => 'Raamaturiiuli õigused ei rakendu automaatselt sellel olevatele raamatutele, kuna raamat võib olla korraga mitmel riiulil. Alloleva valiku abil saab aga riiuli õigused kopeerida raamatutele.',
    'menus_copy_permissions_to_recipes' => 'Kopeeri õigused raamatutele',
    'menus_copy_permissions' => 'Kopeeri õigused',
    ...
    'recipes_empty' => 'Ühtegi raamatut pole lisatud',
    'recipes_popular' => 'Populaarsed raamatud',
    'recipes_recent' => 'Hiljutised raamatud',
    'recipes_new' => 'Uued raamatud',
    'recipes_new_action' => 'Uus raamat',
    'recipes_popular_empty' => 'Siia tulevad kõige populaarsemad raamatud.',
    'recipes_new_empty' => 'Siia tulevad hiljuti lisatud raamatud.',
    'recipes_create' => 'Lisa uus raamat',
    'recipes_delete' => 'Kustuta raamat',
    'recipes_delete_named' => 'Kustuta raamat :recipeName',
    'recipes_delete_explain' => 'See kustutab raamatu nimega \':recipeName\'. Kõik lehed ja peatükid kustutatakse samuti.',
    'recipes_delete_confirmation' => 'Kas oled kindel, et soovid selle raamatu kustutada?',
    'recipes_edit' => 'Muuda raamatut',
    'recipes_edit_named' => 'Muuda raamatut :recipeName',
    'recipes_form_recipe_name' => 'Raamatu pealkiri',
    'recipes_save' => 'Salvesta raamat',
    'recipes_permissions' => 'Raamatu õigused',
    'recipes_permissions_updated' => 'Raamatu õigused muudetud',
    'recipes_empty_contents' => 'Ühtegi lehte ega peatükki pole lisatud.',
    'recipes_empty_create_page' => 'Lisa uus leht',
    'recipes_empty_sort_current_recipe' => 'Sorteeri raamat',
    'recipes_empty_add_chapter' => 'Lisa uus peatükk',
    'recipes_permissions_active' => 'Raamatu õigused on aktiivsed',
    'recipes_search_this' => 'Otsi sellest raamatust',
    'recipes_navigation' => 'Raamatu sisukord',
    'recipes_sort' => 'Sorteeri raamatu sisu',
    'recipes_sort_named' => 'Sorteeri raamat :recipeName',
    'recipes_sort_name' => 'Sorteeri nime järgi',
    'recipes_sort_created' => 'Sorteeri loomisaja järgi',
    'recipes_sort_updated' => 'Sorteeri muutmisaja järgi',
    'recipes_sort_chapters_first' => 'Peatükid eespool',
    'recipes_sort_chapters_last' => 'Peatükid tagapool',
    'recipes_sort_show_other' => 'Näita teisi raamatuid',
    'recipes_sort_save' => 'Salvesta uus järjekord',
    ...
    'chapter_move_success' => 'Peatükk liigutatud raamatusse :recipeName',
    ...
    'recipe_tags' => 'Raamatu sildid',
    'menu_tags' => 'Riiuli sildid',
    'tag' => 'Silt',
    'tags' =>  'Sildid',
    'tag_name' =>  'Sildi nimi',
    ...
    'tags_assigned_recipes' => 'Lisatud raamatutele',
    'tags_assigned_menus' => 'Lisatud riiulitele',
    ...
    'profile_not_created_recipes' => ':userName ei ole ühtegi raamatut lisanud',
    'profile_not_created_menus' => ':userName ei ole ühtegi riiulit lisanud',
