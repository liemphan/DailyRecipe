...
return [
    ...
    'recently_created_recipes' => '最近作成されたブック',
    ...
    'menus_save' => '本棚を保存',
    'menus_recipes' => 'この本棚のブック',
    'menus_add_recipes' => 'この本棚にブックを追加',
    'menus_drag_recipes' => 'ブックをここにドラッグすると本棚に追加されます',
    'menus_empty_contents' => 'This menu has no recipes assigned to it',
    'menus_edit_and_assign' => 'Edit menu to assign recipes',
    ...
    'recipes' => 'ブック',
    'x_recipes' => ':count ブック',
    'recipes_empty' => 'まだブックは作成されていません',
    'recipes_popular' => '人気のブック',
    'recipes_recent' => '最近のブック',
    'recipes_new' => '新しいブック',
    'recipes_new_action' => '新しいブック',
    'recipes_popular_empty' => 'ここに人気のブックが表示されます。',
    'recipes_new_empty' => 'The most recently created recipes will appear here.',
    'recipes_create' => '新しいブックを作成',
    'recipes_delete' => 'ブックを削除',
    'recipes_delete_named' => 'ブック「:recipeName」を削除',
    'recipes_delete_explain' => '「:recipeName」を削除すると、ブック内のページとチャプターも削除されます。',
    'recipes_delete_confirmation' => '本当にこのブックを削除してよろしいですか？',
    'recipes_edit' => 'ブックを編集',
    'recipes_edit_named' => 'ブック「:recipeName」を編集',
    'recipes_form_recipe_name' => 'ブック名',
    'recipes_save' => 'ブックを保存',
    'recipes_permissions' => 'ブックの権限',
    'recipes_permissions_updated' => 'ブックの権限を更新しました',
    'recipes_empty_contents' => 'まだページまたはチャプターが作成されていません。',
    'recipes_empty_create_page' => '新しいページを作成',
    'recipes_empty_sort_current_recipe' => 'ブックの並び順を変更',
    'recipes_empty_add_chapter' => 'チャプターを追加',
    'recipes_permissions_active' => 'ブックの権限は有効です',
    'recipes_search_this' => 'このブックから検索',
    'recipes_navigation' => '目次',
    'recipes_sort' => '並び順を変更',
    'recipes_sort_named' => 'ブック「:recipeName」を並べ替え',
    'recipes_sort_name' => '名前で並べ替え',
    'recipes_sort_created' => '作成日で並べ替え',
    'recipes_sort_updated' => '更新日で並べ替え',
    'recipes_sort_chapters_first' => 'チャプターを先に',
    'recipes_sort_chapters_last' => 'チャプターを後に',
    'recipes_sort_show_other' => '他のブックを表示',
    'recipes_sort_save' => '並び順を保存',
    ...
    'chapter_move_success' => 'チャプターを「:recipeName」に移動しました',
    ...
    'profile_not_created_recipes' => ':userNameはブックを作成していません',
