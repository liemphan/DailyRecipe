...
return [
    ...
    'images' => 'Ảnh',
    'my_recent_drafts' => 'Bản nháp gần đây',
    'my_recently_viewed' => 'Xem gần đây',
    'my_most_viewed_favourites' => 'Danh sách yêu thích nhất',
    'my_favourites' => 'Yêu thích',
    ...
    'menus_drag_recipes' => 'Kéo c đơn này không có công thức nào',
    'menus_edit_and_assign' => 'Chỉnh sửa thực đơn để gán công thức',
    'menus_edit_named' => 'Chỉnh sửa ông thức vào đây để thêm vào thực đơn',
    'menus_empty_contents' => 'Thựcthực đơn :name',
    ...
    'recipes_create' => 'Tạo công thức  mới',
    ...
    'tags_all_values' => 'Tất cả các giá trị',
    'tags_view_tags' => 'Xem Thẻ',
    'tags_view_existing_tags' => 'Xem các thẻ hiện có',
    'tags_list_empty_hint' => 'Thẻ có thể được chỉ định thông qua thanh bên của trình chỉnh sửa trang hoặc trong khi chỉnh sửa các chi tiết của công thức, chương hoặc menu.',
