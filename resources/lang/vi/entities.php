...
return [
    ...
    // Books
    'book' => 'Công thức nấu ăn',
    'books' => 'Tất cả công thức nấu ăn',
    'x_books' => ':count Công thức nấu ăn|:count Công thức nấu ăn',
    'books_empty' => 'Không có công thức nấu ăn nào được tạo',
    'books_popular' => 'Những công thức nấu ăn phổ biến',
    'books_recent' => 'Những công thức nấu ăn gần đây',
    'books_new' => 'Những công thức nấu ăn mới',
    'books_new_action' => 'Công thức nấu ăn mới',
    'books_popular_empty' => 'Những công thức nấu ăn phổ biến nhất sẽ xuất hiện ở đây.',
    'books_new_empty' => 'Những công thức nấu ăn tạo gần đây sẽ được xuất hiện ở đây.',
    'books_create' => 'Tạo công thức nấu ăn mới',
    'books_delete' => 'Xóa công thức nấu ăn',
    'books_delete_named' => 'Xóa công thức nấu ăn :bookName',
    'books_delete_explain' => 'Điều này sẽ xóa công thức nấu ăn với tên \':bookName\'. Tất cả các trang và các chương sẽ bị xóa.',
    'books_delete_confirmation' => 'Bạn có chắc chắn muốn xóa công thức nấu ăn này?',
    'books_edit' => 'Sửa công thức nấu ăn',
    'books_edit_named' => 'Sửa công thức nấu ăn :bookName',
    'books_form_book_name' => 'Tên công thức nấu ăn',
    'books_save' => 'Lưu công thức nấu ăn',
    'books_permissions' => 'Các quyền của công thức nấu ăn',
    'books_permissions_updated' => 'Các quyền của công thức nấu ăn đã được cập nhật',
    'books_empty_contents' => 'Không có trang hay chương nào được tạo cho công thức nấu ăn này.',
    'books_empty_create_page' => 'Tao một trang mới',
    'books_empty_sort_current_book' => 'Sắp xếp công thức nấu ăn này',
    'books_empty_add_chapter' => 'Thêm một chương mới',
    'books_permissions_active' => 'Đang bật các quyền hạn từ công thức nấu ăn',
    'books_search_this' => 'Tìm công thức nấu ăn này',
    'books_navigation' => 'Điều hướng công thức nấu ăn',
    'books_sort' => 'Sắp xếp nội dung công thức nấu ăn',
    'books_sort_named' => 'Sắp xếp công thức nấu ăn :bookName',
    ...
    'books_sort_show_other' => 'Hiển thị các công thức nấu ăn khác',
