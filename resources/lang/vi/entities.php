...
return [
    ...
    'menus_long' => 'Giá sách',
    'menus_empty' => 'Không có giá nào được tạo',
    'menus_create' => 'Tạo Giá mới',
    'menus_popular' => 'Các Giá phổ biến',
    'menus_new' => 'Các Giá mới',
    'menus_new_action' => 'Giá mới',
    'menus_popular_empty' => 'Các giá phổ biến sẽ xuất hiện ở đây.',
    'menus_new_empty' => 'Các Giá được tạo gần đây sẽ xuất hiện ở đây.',
    'menus_save' => 'Lưu Giá',
    'menus_recipes' => 'Sách trên Giá này',
    'menus_add_recipes' => 'Thêm sách vào Giá này',
    'menus_drag_recipes' => 'Kéo sách vào đây để thêm vào giá',
    'menus_empty_contents' => 'Giá này không có sách nào',
    'menus_edit_and_assign' => 'Chỉnh sửa kệ để gán sách',
    'menus_edit_named' => 'Chỉnh sửa kệ sách :name',
    'menus_edit' => 'Chỉnh sửa kệ sách',
    'menus_delete' => 'Xóa kệ sách',
    'menus_delete_named' => 'Xóa kệ sách :name',
    'menus_delete_explain' => "Chức năng này sẽ xóa kệ sách với tên ':name'. Các sách chứa trong nó sẽ không bị xóa.",
    'menus_delete_confirmation' => 'Bạn có chắc chắn muốn xóa kệ sách này?',
    'menus_permissions' => 'Các quyền đối với kệ sách',
    'menus_permissions_updated' => 'Các quyền với kệ sách đã được cập nhật',
    'menus_permissions_active' => 'Đang bật các quyền hạn từ Kệ sách',
    'menus_permissions_cascade_warning' => 'Các quyền trên giá sách sẽ không được tự động gán cho các sách trên đó. Vì một quyển sách có thể tồn tại trên nhiều giá sách. Các quyền có thể được sao chép xuống các quyển sách sử dụng tuỳ chọn dưới đây.',
    'menus_copy_permissions_to_recipes' => 'Sao chép các quyền cho sách',
