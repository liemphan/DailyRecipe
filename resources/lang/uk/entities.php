...
return [
    ...
    'recently_created_recipes' => 'Нещодавно створені книги',
    'recently_created_menus' => 'Нещодавно створені полиці',
    ...
    'menu' => 'Полиця',
    'menus' => 'Полиці',
    'x_menus' => ':count Полиця|:count Полиць',
    'menus_long' => 'Книжкові полиці',
    'menus_empty' => 'Жодних полиць не було створено',
    'menus_create' => 'Створити нову полицю',
    'menus_popular' => 'Популярні полиці',
    'menus_new' => 'Нові полиці',
    'menus_new_action' => 'Нова полиця',
    'menus_popular_empty' => 'Найпопулярніші полиці з\'являться тут.',
    'menus_new_empty' => 'Тут будуть з\'являтися останні створені полиці.',
    'menus_save' => 'Зберегти полицю',
    'menus_recipes' => 'Книги на цій полиці',
    'menus_add_recipes' => 'Додати книги до цієї полиці',
    'menus_drag_recipes' => 'Перетягніть книги сюди, щоб додати їх до цієї полиці',
    'menus_empty_contents' => 'Ця полиця не має призначених їй книг',
    'menus_edit_and_assign' => 'Редагувати полицю для присвоєння книг',
    'menus_edit_named' => 'Редагувати книжкову полицю :name',
    'menus_edit' => 'Редагувати книжкову полицю',
    'menus_delete' => 'Видалити книжкову полицю',
    'menus_delete_named' => 'Видалити книжкову полицю :name',
    'menus_delete_explain' => "Це дозволить видалити книжкову полицю з назвою ':name'. Книги не будуть видалені.",
    'menus_delete_confirmation' => 'Ви впевнені, що хочете видалити цю книжкову полицю?',
    ...
    'menus_copy_permissions_to_recipes' => 'Копіювати дозволи на книги',
    ...
    'menus_copy_permission_success' => 'Дозволи книжкової полиці скопійовано на :count книг',

    // Books
    'recipe' => 'Книга',
    'recipes' => 'Книги',
    'x_recipes' => ':count книга|:count книг',
    'recipes_empty' => 'Немає створених книг',
    'recipes_popular' => 'Популярні книги',
    'recipes_recent' => 'Останні книги',
    'recipes_new' => 'Нові книги',
    'recipes_new_action' => 'Нова книга',
    'recipes_popular_empty' => 'Найпопулярніші книги з\'являться тут.',
    'recipes_new_empty' => 'Найновіші книги з\'являться тут.',
    'recipes_create' => 'Створити нову книгу',
    'recipes_delete' => 'Видалити книгу',
    'recipes_delete_named' => 'Видалити книгу :recipeName',
    'recipes_delete_explain' => 'Це призведе до видалення книги з назвою \':recipeName\'. Всі сторінки та розділи будуть видалені.',
    'recipes_delete_confirmation' => 'Ви впевнені, що хочете видалити цю книгу?',
    'recipes_edit' => 'Редагувати книгу',
    'recipes_edit_named' => 'Редагувати книгу :recipeName',
    'recipes_form_recipe_name' => 'Назва книги',
    'recipes_save' => 'Зберегти книгу',
    'recipes_permissions' => 'Дозволи на книгу',
    'recipes_permissions_updated' => 'Дозволи на книгу оновлено',
    'recipes_empty_contents' => 'Для цієї книги не створено жодної сторінки або розділів.',
    'recipes_empty_create_page' => 'Створити нову сторінку',
    'recipes_empty_sort_current_recipe' => 'Сортувати поточну книгу',
    'recipes_empty_add_chapter' => 'Додати розділ',
    'recipes_permissions_active' => 'Діючі дозволи на книгу',
    'recipes_search_this' => 'Шукати цю книгу',
    'recipes_navigation' => 'Навігація по книзі',
    'recipes_sort' => 'Сортувати вміст книги',
    'recipes_sort_named' => 'Сортувати книгу :recipeName',
    'recipes_sort_name' => 'Сортувати за назвою',
    'recipes_sort_created' => 'Сортувати за датою створення',
    'recipes_sort_updated' => 'Сортувати за датою оновлення',
    'recipes_sort_chapters_first' => 'Спершу розділи',
    'recipes_sort_chapters_last' => 'Розділи в кінці',
    'recipes_sort_show_other' => 'Показати інші книги',
    'recipes_sort_save' => 'Зберегти нове замовлення',
    ...
    'chapter_move_success' => 'Розділ переміщено до :recipeName',
    ...
    'recipe_tags' => 'Теги книг',
    'menu_tags' => 'Теги полиць',
    'tag' => 'Тег',
    'tags' =>  'Теги',
    'tag_name' =>  'Назва тегу',
    ...
    'profile_not_created_recipes' => ':userName не створив жодної книги',
    'profile_not_created_menus' => ':userName не створив жодної полиці',
