...
return [
    ...
    'recently_created_recipes' => '最近创建的图书',
    'recently_created_menus' => '最近创建的书架',
    ...
    'menu' => '书架',
    'menus' => '书架',
    'x_menus' => ':count 书架|:count 书架',
    'menus_long' => '书架',
    'menus_empty' => '当前未创建书架',
    'menus_create' => '创建新书架',
    'menus_popular' => '热门书架',
    'menus_new' => '新书架',
    'menus_new_action' => '新书架',
    'menus_popular_empty' => '最热门的书架',
    'menus_new_empty' => '最新创建的书架',
    'menus_save' => '保存书架',
    'menus_recipes' => '书籍已在此书架里',
    'menus_add_recipes' => '将书籍加入此书架',
    'menus_drag_recipes' => '拖动图书将其添加到此书架',
    'menus_empty_contents' => '这个书架没有分配图书',
    'menus_edit_and_assign' => '编辑书架以分配图书',
    'menus_edit_named' => '编辑书架 :name',
    'menus_edit' => '编辑书架',
    'menus_delete' => '删除书架',
    'menus_delete_named' => '删除书架 :name',
    'menus_delete_explain' => "此操作将删除书架 ':name'。 其中包含的图书不会被删除。",
    'menus_delete_confirmation' => '您确定要删除此书架吗？',
    'menus_permissions' => '书架权限',
    'menus_permissions_updated' => '书架权限已更新',
    'menus_permissions_active' => '书架权限激活',
    'menus_permissions_cascade_warning' => '书架上的权限不会自动应用到书架里的书。这是因为书可以在多个书架上存在。使用下面的选项可以将权限复制到书架里的书上。',
    'menus_copy_permissions_to_recipes' => '将权限复制到图书',
    'menus_copy_permissions' => '复制权限',
    ...
    'recipes' => '图书',
    'x_recipes' => ':count 本书',
    'recipes_empty' => '不存在已创建的书',
    'recipes_popular' => '热门图书',
    'recipes_recent' => '最近的书',
    'recipes_new' => '新书',
    'recipes_new_action' => '新书',
    'recipes_popular_empty' => '最受欢迎的图书将出现在这里。',
    'recipes_new_empty' => '最近创建的图书将出现在这里。',
    'recipes_create' => '创建图书',
    'recipes_delete' => '删除图书',
    'recipes_delete_named' => '删除图书「:recipeName」',
    'recipes_delete_explain' => '这将删除图书「:recipeName」。所有的章节和页面都会被删除。',
    'recipes_delete_confirmation' => '您确定要删除此图书吗？',
    'recipes_edit' => '编辑图书',
    'recipes_edit_named' => '编辑图书「:recipeName」',
    'recipes_form_recipe_name' => '书名',
    'recipes_save' => '保存图书',
    'recipes_permissions' => '图书权限',
    'recipes_permissions_updated' => '图书权限已更新',
    'recipes_empty_contents' => '本书目前没有页面或章节。',
    'recipes_empty_create_page' => '创建页面',
    'recipes_empty_sort_current_recipe' => '排序当前图书',
    'recipes_empty_add_chapter' => '添加章节',
    'recipes_permissions_active' => '有效的图书权限',
    'recipes_search_this' => '搜索这本书',
    'recipes_navigation' => '图书导航',
    'recipes_sort' => '排序图书内容',
    'recipes_sort_named' => '排序图书「:recipeName」',
    'recipes_sort_name' => '按名称排序',
    'recipes_sort_created' => '创建时间排序',
    'recipes_sort_updated' => '按更新时间排序',
    'recipes_sort_chapters_first' => '章节正序',
    'recipes_sort_chapters_last' => '章节倒序',
    'recipes_sort_show_other' => '显示其他图书',
    'recipes_sort_save' => '保存新顺序',
    ...
    'chapter_move_success' => '章节移动到「:recipeName」',
    ...
    'tags_assigned_recipes' => '有这个标签的图书',
    'tags_assigned_menus' => '有这个标签的书架',
    ...
    'profile_not_created_recipes' => ':userName尚未创建任何图书',
    'profile_not_created_menus' => ':userName 尚未创建任何书架',
