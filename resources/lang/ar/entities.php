...
return [
    ...
    'recently_created_recipes' => 'كتب أنشئت مؤخراً',
    'recently_created_menus' => 'أرفف أنشئت مؤخراً',
    ...
    'menu' => 'رف',
    'menus' => 'الأرفف',
    'x_menus' => ':count رف|:count أرفف',
    'menus_long' => 'أرفف الكتب',
    'menus_empty' => 'لم ينشأ أي رف',
    'menus_create' => 'إنشاء رف جديد',
    'menus_popular' => 'أرفف رائجة',
    'menus_new' => 'أرفف جديدة',
    'menus_new_action' => 'رف جديد',
    'menus_popular_empty' => 'ستظهر هنا الأرفف الأكثر رواجًا.',
    'menus_new_empty' => 'ستظهر هنا الأرفف التي أنشئت مؤخرًا.',
    'menus_save' => 'حفظ الرف',
    'menus_recipes' => 'كتب على هذا الرف',
    'menus_add_recipes' => 'إضافة كتب لهذا الرف',
    'menus_drag_recipes' => 'اسحب الكتب هنا لإضافتها في هذا الرف',
    'menus_empty_contents' => 'لا توجد كتب مخصصة لهذا الرف',
    'menus_edit_and_assign' => 'تحرير الرف لإدراج كتب',
    'menus_edit_named' => 'تحرير رف الكتب :name',
    'menus_edit' => 'تحرير رف الكتب',
    'menus_delete' => 'حذف رف الكتب',
    'menus_delete_named' => 'حذف رف الكتب :name',
    'menus_delete_explain' => "سيؤدي هذا إلى حذف رف الكتب المسمى ':name'، ولن تحذف الكتب المتضمنة فيه.",
    'menus_delete_confirmation' => 'هل أنت متأكد من أنك تريد حذف هذا الرف؟',
    ...
    'menus_copy_permissions_to_recipes' => 'نسخ أذونات الوصول إلى الكتب',
    ...
    'recipes_empty' => 'لم يتم إنشاء أي كتب',
    'recipes_popular' => 'كتب رائجة',
    'recipes_recent' => 'كتب حديثة',
    'recipes_new' => 'كتب جديدة',
    'recipes_new_action' => 'كتاب جديد',
    'recipes_popular_empty' => 'الكتب الأكثر رواجاً ستظهر هنا.',
    'recipes_new_empty' => 'الكتب المنشأة مؤخراً ستظهر هنا.',
    'recipes_create' => 'إنشاء كتاب جديد',
    'recipes_delete' => 'حذف الكتاب',
    'recipes_delete_named' => 'حذف كتاب :recipeName',
    'recipes_delete_explain' => 'سيتم حذف كتاب \':recipeName\'، وأيضا حذف جميع الفصول والصفحات.',
    'recipes_delete_confirmation' => 'تأكيد حذف الكتاب؟',
    'recipes_edit' => 'تعديل الكتاب',
    'recipes_edit_named' => 'تعديل كتاب :recipeName',
    'recipes_form_recipe_name' => 'اسم الكتاب',
    'recipes_save' => 'حفظ الكتاب',
    'recipes_permissions' => 'أذونات الكتاب',
    'recipes_permissions_updated' => 'تم تحديث أذونات الكتاب',
    'recipes_empty_contents' => 'لم يتم إنشاء أي صفحات أو فصول لهذا الكتاب.',
    'recipes_empty_create_page' => 'إنشاء صفحة جديدة',
    'recipes_empty_sort_current_recipe' => 'فرز الكتاب الحالي',
    'recipes_empty_add_chapter' => 'إضافة فصل',
    'recipes_permissions_active' => 'أذونات الكتاب مفعلة',
    'recipes_search_this' => 'البحث في هذا الكتاب',
    'recipes_navigation' => 'تصفح الكتاب',
    'recipes_sort' => 'فرز محتويات الكتاب',
    'recipes_sort_named' => 'فرز كتاب :recipeName',
    'recipes_sort_name' => 'ترتيب حسب الإسم',
    'recipes_sort_created' => 'ترتيب حسب تاريخ الإنشاء',
    'recipes_sort_updated' => 'فرز حسب تاريخ التحديث',
    'recipes_sort_chapters_first' => 'الفصول الأولى',
    'recipes_sort_chapters_last' => 'الفصول الأخيرة',
    'recipes_sort_show_other' => 'عرض كتب أخرى',
    'recipes_sort_save' => 'حفظ الترتيب الجديد',
    ...
    'chapter_move_success' => 'تم نقل الفصل إلى :recipeName',
    ...
    'recipe_tags' => 'وسوم الكتاب',
    'menu_tags' => 'علامات الرف',
    'tag' => 'وسم',
    'tags' =>  'وسوم',
    ...
    'profile_not_created_recipes' => 'لم يتم إنشاء أي كتب بواسطة :userName',
    'profile_not_created_menus' => 'لم يقم "اسم المستخدم"بإنشاء أي أرفف',
