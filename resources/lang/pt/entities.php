...
return [
    ...
    'recently_created_recipes' => 'Livros Criados Recentemente',
    'recently_created_menus' => 'Estantes Criadas Recentemente',
    ...
    'menus_long' => 'Estantes de Livros',
    'menus_empty' => 'Nenhuma estante foi criada',
    'menus_create' => 'Criar Nova Estante',
    'menus_popular' => 'Estantes Populares',
    'menus_new' => 'Estantes Novas',
    'menus_new_action' => 'Nova Estante',
    'menus_popular_empty' => 'As estantes mais populares serão mostradas aqui.',
    'menus_new_empty' => 'As mais recentes estantes criadas serão mostradas aqui.',
    'menus_save' => 'Guardar Estante',
    'menus_recipes' => 'Livros nesta estante',
    'menus_add_recipes' => 'Adicionar livros a esta estante',
    'menus_drag_recipes' => 'Arraste livros aqui para adicioná-los a esta estante',
    'menus_empty_contents' => 'Esta estante não tem livros atribuídos',
    'menus_edit_and_assign' => 'Editar estante para atribuir livros',
    'menus_edit_named' => 'Editar Estante de Livros :name',
    'menus_edit' => 'Editar Estante de Livros',
    'menus_delete' => 'Eliminar Estante de Livros',
    'menus_delete_named' => 'Excluir Prateleira de Livros :name',
    'menus_delete_explain' => "A ação vai eliminar a estante de nome ':name'. Os livros nela presentes não serão eliminados.",
    'menus_delete_confirmation' => 'Tem a certeza que quer eliminar esta estante de livros?',
    'menus_permissions' => 'Permissões da Estante',
    'menus_permissions_updated' => 'Permissões da Estante de Livros Atualizada',
    'menus_permissions_active' => 'Permissões da Estante de Livros Ativas',
    'menus_permissions_cascade_warning' => 'As permissões nas estantes não são passadas automaticamente em efeito dominó para os livros contidos. Isto acontece porque um livro pode existir em várias prateleiras. As permissões podem, no entanto, ser copiadas para livros filhos usando a opção encontrada abaixo.',
    'menus_copy_permissions_to_recipes' => 'Copiar Permissões para Livros',
    'menus_copy_permissions' => 'Copiar Permissões',
    'menus_copy_permissions_explain' => 'Isto aplicará as configurações de permissões atuais desta estante a todos os livros nela contidos. Antes de ativar, assegure-se de que quaisquer alterações nas permissões desta estante foram guardadas.',
    'menus_copy_permission_success' => 'Permissões de estante copiadas para :count livros',

    // Books
    'recipe' => 'Livro',
    'recipes' => 'Livros',
    'x_recipes' => ':count Livro|:count Livros',
    'recipes_empty' => 'Nenhum livro foi criado',
    'recipes_popular' => 'Livros Populares',
    'recipes_recent' => 'Livros Recentes',
    'recipes_new' => 'Livros Novos',
    'recipes_new_action' => 'Novo Livro',
    'recipes_popular_empty' => 'Os livros mais populares serão mostrados aqui.',
    'recipes_new_empty' => 'Os livros mais recentemente criados serão mostrados aqui.',
    'recipes_create' => 'Criar Livro Novo',
    'recipes_delete' => 'Eliminar Livro',
    'recipes_delete_named' => 'Eliminar Livro :recipeName',
    'recipes_delete_explain' => 'A ação vai eliminar o livro com de nome \':recipeName\'. Todas as páginas e capítulos serão também removidos.',
    'recipes_delete_confirmation' => 'Tem a certeza que quer eliminar este livro?',
    'recipes_edit' => 'Editar Livro',
    'recipes_edit_named' => 'Editar Livro :recipeName',
    'recipes_form_recipe_name' => 'Nome do Livro',
    'recipes_save' => 'Guardar Livro',
    'recipes_permissions' => 'Permissões do Livro',
    'recipes_permissions_updated' => 'Permissões do Livro Atualizadas',
    'recipes_empty_contents' => 'Nenhuma página ou capítulo foram criados para este livro.',
    'recipes_empty_create_page' => 'Criar uma nova página',
    'recipes_empty_sort_current_recipe' => 'Ordenar o livro atual',
    'recipes_empty_add_chapter' => 'Adicionar um capítulo',
    'recipes_permissions_active' => 'Permissões do Livro Ativas',
    'recipes_search_this' => 'Pesquisar neste livro',
    'recipes_navigation' => 'Navegação do Livro',
    'recipes_sort' => 'Ordenar Conteúdos do Livro',
    'recipes_sort_named' => 'Ordenar Livro :recipeName',
    'recipes_sort_name' => 'Ordenar por Nome',
    'recipes_sort_created' => 'Ordenar por Data de Criação',
    'recipes_sort_updated' => 'Ordenar por Data de Atualização',
    'recipes_sort_chapters_first' => 'Capítulos Primeiro',
    'recipes_sort_chapters_last' => 'Capítulos por Último',
    'recipes_sort_show_other' => 'Mostrar Outros Livros',
    'recipes_sort_save' => 'Guardar Nova Ordenação',
    ...
    'chapter_move_success' => 'Capítulo movido para :recipeName',
    ...
    'recipe_tags' => 'Etiquetas do Livro',
    'menu_tags' => 'Etiquetas da Prateleira',
    'tag' => 'Etiqueta',
    'tags' =>  'Etiquetas',
    ...
    'profile_not_created_recipes' => ':userName não criou livros',
    'profile_not_created_menus' => ':userName não criou estantes',
