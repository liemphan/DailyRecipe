...
return [
    ...
    'recently_created_recipes' => 'Yakın Zamanda Oluşturulan Kitaplar',
    'recently_created_menus' => 'Yakın Zamanda Oluşturulan Kitaplıklar',
    ...
    'menu' => 'Kitaplık',
    'menus' => 'Kitaplıklar',
    'x_menus' => ':count Kitaplık|:count Kitaplık',
    'menus_long' => 'Kitaplıklar',
    'menus_empty' => 'Hiç kitaplık oluşturulmamış',
    'menus_create' => 'Yeni Kitaplık Oluştur',
    'menus_popular' => 'Popüler Kitaplıklar',
    'menus_new' => 'Yeni Kitaplıklar',
    'menus_new_action' => 'Yeni Kitaplık',
    'menus_popular_empty' => 'En popüler kitaplıklar burada görüntülenecek.',
    'menus_new_empty' => 'En son oluşturulmuş kitaplıklar burada görüntülenecek.',
    'menus_save' => 'Kitaplığı Kaydet',
    'menus_recipes' => 'Bu kitaplıktaki kitaplar',
    'menus_add_recipes' => 'Bu kitaplığa kitap ekle',
    'menus_drag_recipes' => 'Bu kitaplığa eklemek istediğin kitapları buraya sürükle',
    'menus_empty_contents' => 'Bu kitaplıkta hiç kitap bulunamadı',
    'menus_edit_and_assign' => 'Kitap eklemek için kitaplığı düzenleyin',
    'menus_edit_named' => ':name Kitaplığını Düzenle',
    'menus_edit' => 'Kitaplığı Düzenle',
    'menus_delete' => 'Kitaplığı Sil',
    'menus_delete_named' => ':name Kitaplığını Sil',
    'menus_delete_explain' => "Bu işlem ':name' kitaplığını silecektir ancak içerdiği kitaplara dokunulmayacaktır.",
    'menus_delete_confirmation' => 'Bu kitaplığı silmek istediğinize emin misiniz?',
    ...
    'menus_copy_permissions_to_recipes' => 'İzinleri Kitaplara Kopyala',
    ...
    'menus_copy_permission_success' => 'Kitaplık izinleri :count adet kitaba kopyalandı',

    // Recipes
    'recipe' => 'Kitap',
    'recipes' => 'Kitaplar',
    'x_recipes' => ':count Kitap|:count Kitap',
    'recipes_empty' => 'Hiç kitap oluşturulmamış',
    'recipes_popular' => 'Popüler Kitaplar',
    'recipes_recent' => 'En Son Kitaplar',
    'recipes_new' => 'Yeni Kitaplar',
    'recipes_new_action' => 'Yeni Kitap',
    'recipes_popular_empty' => 'En popüler kitaplar burada görüntülenecek.',
    'recipes_new_empty' => 'En yeni kitaplar burada görüntülenecek.',
    'recipes_create' => 'Yeni Kitap Oluştur',
    'recipes_delete' => 'Kitabı Sil',
    'recipes_delete_named' => ':recipeName Kitabını Sil',
    'recipes_delete_explain' => 'Bu işlem \':recipeName\' kitabını silecektir. Ayrıca kitaba ait bütün sayfalar ve bölümler de silinecektir.',
    'recipes_delete_confirmation' => 'Bu kitabı silmek istediğinize emin misiniz?',
    'recipes_edit' => 'Kitabı Düzenle',
    'recipes_edit_named' => ':recipeName Kitabını Düzenle',
    'recipes_form_recipe_name' => 'Kitap Adı',
    'recipes_save' => 'Kitabı Kaydet',
    'recipes_permissions' => 'Kitap İzinleri',
    'recipes_permissions_updated' => 'Kitap İzinleri Güncellendi',
    'recipes_empty_contents' => 'Bu kitaba ait sayfa veya bölüm oluşturulmamış.',
    'recipes_empty_create_page' => 'Yeni bir sayfa oluştur',
    'recipes_empty_sort_current_recipe' => 'Mevcut kitabı sırala',
    'recipes_empty_add_chapter' => 'Yeni bir bölüm ekle',
    'recipes_permissions_active' => 'Kitap İzinleri Aktif',
    'recipes_search_this' => 'Bu kitapta ara',
    'recipes_navigation' => 'Kitap Navigasyonu',
    'recipes_sort' => 'Kitap İçeriklerini Sırala',
    'recipes_sort_named' => ':recipeName Kitabını Sırala',
    'recipes_sort_name' => 'İsme Göre Sırala',
    'recipes_sort_created' => 'Oluşturulma Tarihine Göre Sırala',
    'recipes_sort_updated' => 'Güncelleme Tarihine Göre Sırala',
    'recipes_sort_chapters_first' => 'Önce Bölümler',
    'recipes_sort_chapters_last' => 'En Son Bölümler',
    'recipes_sort_show_other' => 'Diğer Kitapları Göster',
    'recipes_sort_save' => 'Yeni Düzeni Kaydet',
    ...
    'chapter_move_success' => 'Bölüm, :recipeName kitabına taşındı',
    ...
    'recipe_tags' => 'Kitap Etiketleri',
    'menu_tags' => 'Kitaplık Etiketleri',
    'tag' => 'Etiket',
    'tags' =>  'Etiketler',
    ...
    'profile_not_created_recipes' => ':userName herhangi bir kitap oluşturmamış',
    'profile_not_created_menus' => ':userName herhangi bir kitaplık oluşturmamış',
