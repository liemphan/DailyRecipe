...
return [
    ...
    'recently_created_recipes' => '최근에 만든 책자',
    'recently_created_menus' => '최근에 만든 서가',
    ...
    'menu' => '서가',
    'menus' => '서가',
    'x_menus' => '서가 :count개|총 :count개',
    'menus_long' => '서가',
    'menus_empty' => '만든 서가가 없습니다.',
    'menus_create' => '서가 만들기',
    'menus_popular' => '많이 읽은 서가',
    'menus_new' => '새로운 서가',
    'menus_new_action' => '새로운 서가',
    'menus_popular_empty' => '많이 읽은 서가 목록',
    'menus_new_empty' => '새로운 서가 목록',
    'menus_save' => '저장',
    'menus_recipes' => '이 서가에 있는 책자들',
    'menus_add_recipes' => '이 서가에 책자 추가',
    'menus_drag_recipes' => '여기에 책자를 드롭하세요.',
    'menus_empty_contents' => '이 서가에 책자가 없습니다.',
    'menus_edit_and_assign' => '서가 바꾸기로 책자를 추가하세요.',
    'menus_edit_named' => ':name 바꾸기',
    'menus_edit' => '서가 바꾸기',
    'menus_delete' => '서가 삭제하기',
    'menus_delete_named' => ':name 삭제하기',
    'menus_delete_explain' => ":name을 지웁니다. 책자는 지우지 않습니다.",
    'menus_delete_confirmation' => '이 서가를 지울 건가요?',
    'menus_permissions' => '서가 권한',
    'menus_permissions_updated' => '서가 권한 바꿈',
    'menus_permissions_active' => '서가 권한 허용함',
    ...
    'menus_copy_permissions_to_recipes' => '권한 맞춤',
    'menus_copy_permissions' => '실행',
    ...
    'recipes_empty' => '만든 책자가 없습니다.',
    'recipes_popular' => '많이 읽은 책자',
    'recipes_recent' => '최근에 읽은 책자',
    'recipes_new' => '새로운 책자',
    'recipes_new_action' => '새로운 책자',
    'recipes_popular_empty' => '많이 읽은 책자 목록',
    'recipes_new_empty' => '새로운 책자 목록',
    'recipes_create' => '책자 만들기',
    'recipes_delete' => '책자 삭제하기',
    'recipes_delete_named' => ':recipeName(을)를 지웁니다.',
    'recipes_delete_explain' => ':recipeName에 있는 모든 챕터와 문서도 지웁니다.',
    'recipes_delete_confirmation' => '이 책자를 지울 건가요?',
    'recipes_edit' => '책자 바꾸기',
    'recipes_edit_named' => ':recipeName(을)를 바꿉니다.',
    'recipes_form_recipe_name' => '책자 이름',
    'recipes_save' => '저장',
    'recipes_permissions' => '책자 권한',
    'recipes_permissions_updated' => '권한 저장함',
    'recipes_empty_contents' => '이 책자에 챕터나 문서가 없습니다.',
    'recipes_empty_create_page' => '문서 만들기',
    'recipes_empty_sort_current_recipe' => '읽고 있는 책자 정렬',
    'recipes_empty_add_chapter' => '챕터 만들기',
    'recipes_permissions_active' => '책자 권한 허용함',
    'recipes_search_this' => '이 책자에서 검색',
    'recipes_navigation' => '목차',
    'recipes_sort' => '다른 책자들',
    'recipes_sort_named' => ':recipeName 정렬',
    'recipes_sort_name' => '제목',
    'recipes_sort_created' => '만든 날짜',
    'recipes_sort_updated' => '수정한 날짜',
    'recipes_sort_chapters_first' => '챕터 우선',
    'recipes_sort_chapters_last' => '문서 우선',
    'recipes_sort_show_other' => '다른 책자들',
    'recipes_sort_save' => '적용',
    ...
    'chapter_move_success' => ':recipeName(으)로 옮김',
    ...
    'profile_not_created_recipes' => ':userName(이)가 만든 책자 없음',
    'profile_not_created_menus' => ':userName(이)가 만든 서가 없음',
