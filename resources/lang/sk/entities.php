...
return [
    ...
    'recently_created_recipes' => 'Nedávno vytvorené knihy',
    'recently_created_menus' => 'Nedávno vytvorené knižnice',
    ...
    'menu' => 'Polica',
    'menus' => 'Police',
    'x_menus' => ':count Menu|:count Police',
    'menus_long' => 'Poličky na knihy',
    'menus_empty' => 'Neboli vytvorené žiadne police',
    'menus_create' => 'Vytvoriť novú policu',
    'menus_popular' => 'Populárne police',
    'menus_new' => 'Nové police',
    'menus_new_action' => 'Nová polica',
    'menus_popular_empty' => 'Najpopulárnejšie police sa objavia tu.',
    'menus_new_empty' => 'Najpopulárnejšie police sa objavia tu.',
    'menus_save' => 'Uložiť policu',
    'menus_recipes' => 'Knihy na tejto polici',
    'menus_add_recipes' => 'Pridať knihy do tejto police',
    'menus_drag_recipes' => 'Potiahnite knihy sem a pridajte ich do tejto police',
    'menus_empty_contents' => 'Táto polica nemá priradené žiadne knihy',
    'menus_edit_and_assign' => 'Uprav policu a priraď knihy',
    'menus_edit_named' => 'Upraviť poličku::name',
    'menus_edit' => 'Upraviť policu',
    'menus_delete' => 'Odstrániť knižnicu',
    'menus_delete_named' => 'Odstrániť knižnicu :name',
    'menus_delete_explain' => "Týmto vymažete policu s názvom ': name'. Obsahované knihy sa neodstránia.",
    'menus_delete_confirmation' => 'Ste si istý, že chcete zmazať túto knižnicu?',
    'menus_permissions' => 'Oprávnenia knižnice',
    'menus_permissions_updated' => 'Oprávnenia knižnice aktualizované',
    'menus_permissions_active' => 'Oprávnenia knižnice aktívne',
    'menus_permissions_cascade_warning' => 'Povolenia na poličkách sa automaticky nepriraďujú k obsiahnutým knihám. Je to preto, že kniha môže existovať na viacerých poličkách. Povolenia však možno skopírovať do kníh pomocou možnosti uvedenej nižšie.',
    'menus_copy_permissions_to_recipes' => 'Kopírovať oprávnenia pre knihy',
    'menus_copy_permissions' => 'Kopírovať oprávnenia',
    ...
    'recipes_empty' => 'Žiadne knihy neboli vytvorené',
    'recipes_popular' => 'Populárne knihy',
    'recipes_recent' => 'Nedávne knihy',
    'recipes_new' => 'Nové knihy',
    'recipes_new_action' => 'Nová kniha',
    'recipes_popular_empty' => 'Najpopulárnejšie knihy sa objavia tu.',
    'recipes_new_empty' => 'Najnovšie knihy sa zobrazia tu.',
    'recipes_create' => 'Vytvoriť novú knihu',
    'recipes_delete' => 'Zmazať knihu',
    'recipes_delete_named' => 'Zmazať knihu :recipeName',
    'recipes_delete_explain' => 'Toto zmaže knihu s názvom \':recipeName\', všetky stránky a kapitoly budú odstránené.',
    'recipes_delete_confirmation' => 'Ste si istý, že chcete zmazať túto knihu?',
    'recipes_edit' => 'Upraviť knihu',
    'recipes_edit_named' => 'Upraviť knihu :recipeName',
    'recipes_form_recipe_name' => 'Názov knihy',
    'recipes_save' => 'Uložiť knihu',
    'recipes_permissions' => 'Oprávnenia knihy',
    'recipes_permissions_updated' => 'Oprávnenia knihy aktualizované',
    'recipes_empty_contents' => 'Pre túto knihu neboli vytvorené žiadne stránky alebo kapitoly.',
    'recipes_empty_create_page' => 'Vytvoriť novú stránku',
    'recipes_empty_sort_current_recipe' => 'Zoradiť aktuálnu knihu',
    'recipes_empty_add_chapter' => 'Pridať kapitolu',
    'recipes_permissions_active' => 'Oprávnenia knihy aktívne',
    'recipes_search_this' => 'Hľadať v tejto knihe',
    'recipes_navigation' => 'Navigácia knihy',
    'recipes_sort' => 'Zoradiť obsah knihy',
    'recipes_sort_named' => 'Zoradiť knihu :recipeName',
    'recipes_sort_name' => 'Zoradiť podľa mena',
    'recipes_sort_created' => 'Zoradiť podľa dátumu vytvorenia',
    'recipes_sort_updated' => 'Zoradiť podľa dátumu aktualizácie',
    'recipes_sort_chapters_first' => 'Kapitoly ako prvé',
    'recipes_sort_chapters_last' => 'Kapitoly ako posledné',
    'recipes_sort_show_other' => 'Zobraziť ostatné knihy',
    'recipes_sort_save' => 'Uložiť nové zoradenie',
    ...
    'chapter_move_success' => 'Kapitola presunutá do :recipeName',
    ...
    'recipe_tags' => 'Štítky kníh',
    'menu_tags' => 'Štítky knižníc',
    'tag' => 'Štítok',
    'tags' =>  'Štítky',
    ...
    'tags_assigned_recipes' => 'Priradené ku knihám',
    'tags_assigned_menus' => 'Priradené k poličkám',
    ...
    'profile_not_created_recipes' => ':userName nevytvoril žiadne knihy',
    'profile_not_created_menus' => ':userName nevytvoril(a) žiadne kapitoly',
