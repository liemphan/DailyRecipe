...
return [
    ...
    'recently_created_recipes' => 'Llibres creats fa poc',
    'recently_created_menus' => 'Prestatges creats fa poc',
    ...
    'menu' => 'Prestatge',
    'menus' => 'Prestatges',
    'x_menus' => ':count prestatge|:count prestatges',
    'menus_long' => 'Prestatges',
    'menus_empty' => 'No hi ha cap prestatge creat',
    'menus_create' => 'Crea un prestatge nou',
    'menus_popular' => 'Prestatges populars',
    'menus_new' => 'Prestatges nous',
    'menus_new_action' => 'Prestatge nou',
    'menus_popular_empty' => 'Aquí apareixeran els prestatges més populars.',
    'menus_new_empty' => 'Aquí apareixeran els prestatges creats fa poc.',
    'menus_save' => 'Desa el prestatge',
    'menus_recipes' => 'Llibres en aquest prestatge',
    'menus_add_recipes' => 'Afegeix llibres a aquest prestatge',
    'menus_drag_recipes' => 'Arrossegueu llibres aquí per a afegir-los a aquest prestatge',
    'menus_empty_contents' => 'Aquest prestatge no té cap llibre assignat',
    'menus_edit_and_assign' => 'Editeu el prestatge per a assignar-hi llibres',
    'menus_edit_named' => 'Edita el prestatge :name',
    'menus_edit' => 'Edita el prestatge',
    'menus_delete' => 'Suprimeix el prestatge',
    'menus_delete_named' => 'Suprimeix el prestatge :name',
    'menus_delete_explain' => "Se suprimirà el prestatge amb el nom ':name'. Els llibres que contingui no se suprimiran.",
    'menus_delete_confirmation' => 'Segur que voleu suprimir aquest prestatge?',
    ...
    'menus_copy_permissions_to_recipes' => 'Copia els permisos als llibres',
    ...
    'recipes_empty' => 'No hi ha cap llibre creat',
    'recipes_popular' => 'Llibres populars',
    'recipes_recent' => 'Llibres recents',
    'recipes_new' => 'Llibres nous',
    'recipes_new_action' => 'Llibre nou',
    'recipes_popular_empty' => 'Aquí apareixeran els llibres més populars.',
    'recipes_new_empty' => 'Aquí apareixeran els llibres creats fa poc.',
    'recipes_create' => 'Crea un llibre nou',
    'recipes_delete' => 'Suprimeix el llibre',
    'recipes_delete_named' => 'Suprimeix el llibre :recipeName',
    'recipes_delete_explain' => 'Se suprimirà el llibre amb el nom \':recipeName\'. Se\'n suprimiran les pàgines i els capítols.',
    'recipes_delete_confirmation' => 'Segur que voleu suprimir aquest llibre?',
    'recipes_edit' => 'Edita el llibre',
    'recipes_edit_named' => 'Edita el llibre :recipeName',
    'recipes_form_recipe_name' => 'Nom del llibre',
    'recipes_save' => 'Desa el llibre',
    'recipes_permissions' => 'Permisos del llibre',
    'recipes_permissions_updated' => 'S\'han actualitzat els permisos del llibre',
    'recipes_empty_contents' => 'No hi ha cap pàgina ni cap capítol creat en aquest llibre.',
    'recipes_empty_create_page' => 'Crea una pàgina nova',
    'recipes_empty_sort_current_recipe' => 'Ordena el llibre actual',
    'recipes_empty_add_chapter' => 'Afegeix un capítol',
    'recipes_permissions_active' => 'S\'han activat els permisos del llibre',
    'recipes_search_this' => 'Cerca en aquest llibre',
    'recipes_navigation' => 'Navegació pel llibre',
    'recipes_sort' => 'Ordena el contingut del llibre',
    'recipes_sort_named' => 'Ordena el llibre :recipeName',
    'recipes_sort_name' => 'Ordena per nom',
    'recipes_sort_created' => 'Ordena per data de creació',
    'recipes_sort_updated' => 'Ordena per data d\'actualització',
    'recipes_sort_chapters_first' => 'Els capítols al principi',
    'recipes_sort_chapters_last' => 'Els capítols al final',
    'recipes_sort_show_other' => 'Mostra altres llibres',
    'recipes_sort_save' => 'Desa l\'ordre nou',
    ...
    'chapter_move_success' => 'S\'ha mogut el capítol a :recipeName',
    ...
    'recipe_tags' => 'Etiquetes del llibre',
    'menu_tags' => 'Etiquetes del prestatge',
    'tag' => 'Etiqueta',
    'tags' =>  'Etiquetes',
    ...
    'profile_not_created_recipes' => ':userName no ha creat cap llibre',
    'profile_not_created_menus' => ':userName no ha creat cap prestatge',
