...
return [
    ...
    'recently_created_recipes' => '最近建立的書本',
    'recently_created_menus' => '最近建立的書架',
    ...
    'menu' => '書架',
    'menus' => '書架',
    'x_menus' => ':count 書架 | :count 章節',
    'menus_long' => '書架',
    'menus_empty' => '尚未建立書架',
    'menus_create' => '建立新書架',
    'menus_popular' => '熱門書架',
    'menus_new' => '新書架',
    'menus_new_action' => '建立新的書架',
    'menus_popular_empty' => '最受歡迎的書架將出現在這裡。',
    'menus_new_empty' => '最近建立的書架將出現在這裡。',
    'menus_save' => '儲存書架',
    'menus_recipes' => '此書架上的書本',
    'menus_add_recipes' => '新增書本至此書架',
    'menus_drag_recipes' => '將書本拖曳到此處來將其新增到此書架',
    'menus_empty_contents' => '此書架沒有分配任何書本',
    'menus_edit_and_assign' => '編輯書架以分配書本',
    'menus_edit_named' => '編輯書架 :name',
    'menus_edit' => '編輯書架',
    'menus_delete' => '刪除書架',
    'menus_delete_named' => '刪除書架 :name',
    'menus_delete_explain' => "這將刪除名為「:name」的書架。但其中的書本不會被刪除。",
    'menus_delete_confirmation' => '您確定要刪除此書架嗎？',
    ...
    'menus_copy_permissions_to_recipes' => '將權限複製到書本',
    ...
    'recipes_empty' => '不存在已建立的書',
    'recipes_popular' => '熱門書本',
    'recipes_recent' => '近期書本',
    'recipes_new' => '新書本',
    'recipes_new_action' => '新書本',
    'recipes_popular_empty' => '最受歡迎的書本將出現在這裡。',
    'recipes_new_empty' => '最近建立的書本將出現在這裡。',
    'recipes_create' => '建立新書本',
    'recipes_delete' => '刪除書本',
    'recipes_delete_named' => '刪除書本 :recipeName',
    'recipes_delete_explain' => '這將刪除書本「:recipeName」。所有的章節和頁面都會被刪除。',
    'recipes_delete_confirmation' => '您確定要刪除此書本嗎？',
    'recipes_edit' => '編輯書本',
    'recipes_edit_named' => '編輯書本「:recipeName」',
    'recipes_form_recipe_name' => '書本名稱',
    'recipes_save' => '儲存書本',
    'recipes_permissions' => '書本權限',
    'recipes_permissions_updated' => '書本權限已更新',
    'recipes_empty_contents' => '本書目前沒有頁面或章節。',
    'recipes_empty_create_page' => '建立新頁面',
    'recipes_empty_sort_current_recipe' => '排序目前書本',
    'recipes_empty_add_chapter' => '新增章節',
    'recipes_permissions_active' => '書本權限已啟用',
    'recipes_search_this' => '搜尋此書本',
    'recipes_navigation' => '書本導覽',
    'recipes_sort' => '排序書本內容',
    'recipes_sort_named' => '排序書本 :recipeName',
    'recipes_sort_name' => '按名稱排序',
    'recipes_sort_created' => '按建立時間排序',
    'recipes_sort_updated' => '按更新時間排序',
    'recipes_sort_chapters_first' => '第一章',
    'recipes_sort_chapters_last' => '最後一章',
    'recipes_sort_show_other' => '顯示其他書本',
    'recipes_sort_save' => '儲存新順序',
    ...
    'chapter_move_success' => '章節移動到 :recipeName',
    ...
    'profile_not_created_recipes' => ':userName 尚未建立任何書本',
    'profile_not_created_menus' => ':userName 沒有創建任何書架',
