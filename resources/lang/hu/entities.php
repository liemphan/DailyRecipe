...
return [
    ...
    'recently_created_recipes' => 'Legutóbb létrehozott könyvek',
    'recently_created_menus' => 'Legutóbb létrehozott polcok',
    ...
    'menu' => 'Polc',
    'menus' => 'Polcok',
    'x_menus' => ':count polc|:count polcok',
    'menus_long' => 'Könyvespolcok',
    'menus_empty' => 'Nincsenek könyvespolcok létrehozva',
    'menus_create' => 'Új polc létrehozása',
    'menus_popular' => 'Népszerű polcok',
    'menus_new' => 'Új polcok',
    'menus_new_action' => 'Új polc',
    'menus_popular_empty' => 'A legnépszerűbb polcok itt fognak megjelenni.',
    'menus_new_empty' => 'A legutoljára létrehozott polcok itt fognak megjelenni.',
    'menus_save' => 'Polc mentése',
    'menus_recipes' => 'Könyvek ezen a polcon',
    'menus_add_recipes' => 'Könyvek hozzáadása ehhez a polchoz',
    'menus_drag_recipes' => 'Könyveket áthúzással lehet elhelyezni ezen a polcon',
    'menus_empty_contents' => 'Ehhez a polchoz nincsenek könyvek rendelve',
    'menus_edit_and_assign' => 'Polc szerkesztése könyvek hozzárendeléséhez',
    'menus_edit_named' => ':name könyvespolc szerkesztése',
    'menus_edit' => 'Könyvespolc szerkesztése',
    'menus_delete' => 'Könyvespolc törlése',
    'menus_delete_named' => ':name könyvespolc törlése',
    'menus_delete_explain' => "':name'. nevű könyvespolc ezzel le lesz törölve. A benne található könyvek nem lesznek törölve.",
    'menus_delete_confirmation' => 'Biztosan törölhető ez a könyvespolc?',
    ...
    'menus_copy_permissions_to_recipes' => 'Jogosultság másolása könyvekre',
    ...
    'menus_copy_permission_success' => 'Könyvespolc jogosultságok átmásolva :count könyvre',

    // Books
    'recipe' => 'Könyv',
    'recipes' => 'Könyvek',
    'x_recipes' => ':count könyv|:count könyv',
    'recipes_empty' => 'Nincsenek könyvek létrehozva',
    'recipes_popular' => 'Népszerű könyvek',
    'recipes_recent' => 'Legutóbbi könyvek',
    'recipes_new' => 'Új könyvek',
    'recipes_new_action' => 'Új könyv',
    'recipes_popular_empty' => 'A legnépszerűbb könyvek itt fognak megjelenni.',
    'recipes_new_empty' => 'A legutoljára létrehozott könyvek itt fognak megjelenni.',
    'recipes_create' => 'Új könyv létrehozása',
    'recipes_delete' => 'Könyv törlése',
    'recipes_delete_named' => ':recipeName könyv törlése',
    'recipes_delete_explain' => '\':recipeName\' nevű könyv törölve lesz. Minden oldal és fejezet el lesz távolítva.',
    'recipes_delete_confirmation' => 'Biztosan törölhető ez a könyv?',
    'recipes_edit' => 'Könyv szerkesztése',
    'recipes_edit_named' => ':recipeName könyv szerkesztése',
    'recipes_form_recipe_name' => 'Könyv neve',
    'recipes_save' => 'Könyv mentése',
    'recipes_permissions' => 'Könyv jogosultságok',
    'recipes_permissions_updated' => 'Könyv jogosultságok frissítve',
    'recipes_empty_contents' => 'Ehhez a könyvhöz nincsenek oldalak vagy fejezetek létrehozva.',
    'recipes_empty_create_page' => 'Új oldal létrehozása',
    'recipes_empty_sort_current_recipe' => 'Aktuális könyv rendezése',
    'recipes_empty_add_chapter' => 'Fejezet hozzáadása',
    'recipes_permissions_active' => 'Könyv jogosultságok aktívak',
    'recipes_search_this' => 'Keresés ebben a könyvben',
    'recipes_navigation' => 'Könyv navigáció',
    'recipes_sort' => 'Könyv tartalmak rendezése',
    'recipes_sort_named' => ':recipeName könyv rendezése',
    'recipes_sort_name' => 'Rendezés név szerint',
    'recipes_sort_created' => 'Rendezés létrehozás dátuma szerint',
    'recipes_sort_updated' => 'Rendezés frissítés dátuma szerint',
    'recipes_sort_chapters_first' => 'Fejezetek elől',
    'recipes_sort_chapters_last' => 'Fejezetek hátul',
    'recipes_sort_show_other' => 'Egyéb könyvek mutatása',
    'recipes_sort_save' => 'Új elrendezés mentése',
    ...
    'chapter_move_success' => 'Fejezet áthelyezve :recipeName könyvbe',
    ...
    'recipe_tags' => 'Könyv címkék',
    'menu_tags' => 'Polc címkék',
    'tag' => 'Címke',
    'tags' =>  'Címkék',
    'tag_name' =>  'Címkenév',
    ...
    'profile_not_created_recipes' => ':userName még nem hozott létre könyvet',
    'profile_not_created_menus' => ':userName még nem hozott létre polcot',
