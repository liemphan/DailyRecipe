...
return [
    ...
    'recently_created_recipes' => 'Недавно созданные книги',
    'recently_created_menus' => 'Недавно созданные полки',
    ...
    'menu' => 'Полка',
    'menus' => 'Полки',
    'x_menus' => ':count полка|:count полки|:count полок',
    'menus_long' => 'Книжные полки',
    'menus_empty' => 'Полки не созданы',
    'menus_create' => 'Создать новую полку',
    'menus_popular' => 'Популярные полки',
    'menus_new' => 'Новые полки',
    'menus_new_action' => 'Новая полка',
    'menus_popular_empty' => 'Популярные полки появятся здесь.',
    'menus_new_empty' => 'Последние созданные полки появятся здесь.',
    'menus_save' => 'Сохранить полку',
    'menus_recipes' => 'Книги из этой полки',
    'menus_add_recipes' => 'Добавить книгу в эту полку',
    'menus_drag_recipes' => 'Перетащите книги сюда, чтобы добавить их на эту полку',
    'menus_empty_contents' => 'На этой полке нет книг',
    'menus_edit_and_assign' => 'Изменить полку для привязки книг',
    'menus_edit_named' => 'Редактировать полку :name',
    'menus_edit' => 'Редактировать книжную полку',
    'menus_delete' => 'Удалить книжную полку',
    'menus_delete_named' => 'Удалить книжную полку :name',
    'menus_delete_explain' => "Это приведет к удалению полки с именем ':name'. Привязанные книги удалены не будут.",
    'menus_delete_confirmation' => 'Вы уверены, что хотите удалить эту полку?',
    'menus_permissions' => 'Доступы к книжной полке',
    'menus_permissions_updated' => 'Доступы к книжной полке обновлены',
    'menus_permissions_active' => 'Действующие разрешения книжной полки',
    'menus_permissions_cascade_warning' => 'Разрешения на полки не наследуются автоматически содержащимся в них книгам. Это происходит потому, что книга может находиться на нескольких полках. Однако разрешения могут быть установлены для книг полки с помощью опции, приведенной ниже.',
    'menus_copy_permissions_to_recipes' => 'Наследовать доступы книгам',
    'menus_copy_permissions' => 'Копировать доступы',
    ...
    'recipes_empty' => 'Нет созданных книг',
    'recipes_popular' => 'Популярные книги',
    'recipes_recent' => 'Недавние книги',
    'recipes_new' => 'Новые книги',
    'recipes_new_action' => 'Новая книга',
    'recipes_popular_empty' => 'Здесь появятся самые популярные книги.',
    'recipes_new_empty' => 'Здесь появятся самые последние созданные книги.',
    'recipes_create' => 'Создать новую книгу',
    'recipes_delete' => 'Удалить книгу',
    'recipes_delete_named' => 'Удалить книгу :recipeName',
    'recipes_delete_explain' => 'Это удалит книги с именем \':recipeName\'. Все разделы и страницы будут удалены.',
    'recipes_delete_confirmation' => 'Вы действительно хотите удалить эту книгу?',
    'recipes_edit' => 'Редактировать книгу',
    'recipes_edit_named' => 'Редактировать книгу :recipeName',
    'recipes_form_recipe_name' => 'Название книги',
    'recipes_save' => 'Сохранить книгу',
    'recipes_permissions' => 'Разрешения на книгу',
    'recipes_permissions_updated' => 'Разрешения на книгу обновлены',
    'recipes_empty_contents' => 'Для этой книги нет страниц или разделов.',
    'recipes_empty_create_page' => 'Создать новую страницу',
    'recipes_empty_sort_current_recipe' => 'Сортировка текущей книги',
    'recipes_empty_add_chapter' => 'Добавить главу',
    'recipes_permissions_active' => 'Действующие разрешения книги',
    'recipes_search_this' => 'Поиск в этой книге',
    'recipes_navigation' => 'Навигация по книге',
    'recipes_sort' => 'Сортировка содержимого книги',
    'recipes_sort_named' => 'Сортировка книги :recipeName',
    'recipes_sort_name' => 'По имени',
    'recipes_sort_created' => 'По дате создания',
    'recipes_sort_updated' => 'По дате обновления',
    'recipes_sort_chapters_first' => 'Главы в начале',
    'recipes_sort_chapters_last' => 'Главы в конце',
    'recipes_sort_show_other' => 'Показать другие книги',
    'recipes_sort_save' => 'Сохранить новый порядок',
    ...
    'chapter_move_success' => 'Глава перемещена в :recipeName',
    ...
    'recipe_tags' => 'Теги книги',
    'menu_tags' => 'Теги полки',
    'tag' => 'Тег',
    'tags' =>  'Теги',
    'tag_name' =>  'Имя тега',
    ...
    'tags_assigned_recipes' => 'Назначено на книги',
    'tags_assigned_menus' => 'Назначено на полки',
    ...
    'profile_not_created_recipes' => ':userName не создал ни одной книги',
    'profile_not_created_menus' => ':userName не создал ни одной полки',
