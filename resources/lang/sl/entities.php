...
return [
    ...
    'recently_created_recipes' => 'Nazadnje objavljene knjige',
    'recently_created_menus' => 'Nazadnje ustvarjene police',
    ...
    'menu' => 'Polica',
    'menus' => 'Police',
    'x_menus' => ':count Polica|:count Police',
    'menus_long' => 'Knjižne police',
    'menus_empty' => 'Ustvarjena ni bila nobena polica',
    'menus_create' => 'Ustvari novo polico',
    'menus_popular' => 'Priljubljene police',
    'menus_new' => 'Nove police',
    'menus_new_action' => 'Nova polica',
    'menus_popular_empty' => 'Najbolj priljubljene police se bodo pojavile tukaj.',
    'menus_new_empty' => 'Nazadnje ustvarjene police se bodo pojavile tukaj.',
    'menus_save' => 'Shrani polico',
    'menus_recipes' => 'Knjige na tej polici',
    'menus_add_recipes' => 'Dodaj knjige na to polico',
    'menus_drag_recipes' => 'Povlecite knjige sem, da jih dodate na to polico',
    'menus_empty_contents' => 'Na tej polici ni nobene knjige',
    'menus_edit_and_assign' => 'Uredi knjižno polico za dodajanje knjig',
    'menus_edit_named' => 'Uredi knjižno polico :name',
    'menus_edit' => 'Uredi knjižno polico',
    'menus_delete' => 'Izbriši knjižno polico',
    'menus_delete_named' => 'Izbriši knjižno polico :name',
    'menus_delete_explain' => "S tem boste izbrisali knjižno polico z nazivom ':name'. Vsebovane knjige ne bodo izbrisane.",
    'menus_delete_confirmation' => 'Ali ste prepričani, da želite izbrisati ta knjižno polico?',
    ...
    'menus_copy_permissions_to_recipes' => 'Kopiraj dovoljenja na knjige',
    ...
    'menus_copy_permission_success' => 'Dovoljenja knjižne police kopirana na :count knjig',

    // Books
    'recipe' => 'Knjiga',
    'recipes' => 'Knjige',
    'x_recipes' => ':count Knjiga|:count Knjig',
    'recipes_empty' => 'Ustvarjena ni bila nobena knjiga',
    'recipes_popular' => 'Priljubjene knjige',
    'recipes_recent' => 'Zadnje knjige',
    'recipes_new' => 'Nove knjige',
    'recipes_new_action' => 'Nova knjiga',
    'recipes_popular_empty' => 'Tukaj bodo prikazane najbolj priljubljene knjige.',
    'recipes_new_empty' => 'Tukaj bodo prikazane nazadnje ustvarjene knjige.',
    'recipes_create' => 'Ustvari novo knjigo',
    'recipes_delete' => 'Izbriši knjigo',
    'recipes_delete_named' => 'Izbriši knjigo :recipeName',
    'recipes_delete_explain' => 'S tem boste izbrisali knjigo z nazivom \':recipeName\'. Vse strani in poglavja bodo odstranjena.',
    'recipes_delete_confirmation' => 'Ali ste prepričani, da želite izbrisati to knjigo?',
    'recipes_edit' => 'Uredi knjigo',
    'recipes_edit_named' => 'Uredi knjigo :recipeName',
    'recipes_form_recipe_name' => 'Ime knjige',
    'recipes_save' => 'Shrani knjigo',
    'recipes_permissions' => 'Dovoljenja knjige',
    'recipes_permissions_updated' => 'Posodobljena dovoljenja knjige',
    'recipes_empty_contents' => 'V tej knjigi ni bila ustvarjena še nobena stran ali poglavje.',
    'recipes_empty_create_page' => 'Ustvari novo stran',
    'recipes_empty_sort_current_recipe' => 'Razvrsti trenutno knjigo',
    'recipes_empty_add_chapter' => 'Dodaj poglavje',
    'recipes_permissions_active' => 'Aktivna dovoljenja knjige',
    'recipes_search_this' => 'Išči v tej knjigi',
    'recipes_navigation' => 'Navigacija po knjigi',
    'recipes_sort' => 'Razvrsti vsebino knjige',
    'recipes_sort_named' => 'Razvrsti knjigo :recipeName',
    'recipes_sort_name' => 'Razvrsti po imenu',
    'recipes_sort_created' => 'Razvrsti po datumu nastanka',
    'recipes_sort_updated' => 'Razvrsti po datumu posodobitve',
    'recipes_sort_chapters_first' => 'Najprej poglavja',
    'recipes_sort_chapters_last' => 'Nazadnje poglavja',
    'recipes_sort_show_other' => 'Prikaži druge knjige',
    'recipes_sort_save' => 'Shrani novo razvrstitev',
    ...
    'chapter_move_success' => 'Poglavje premaknjeno v :recipeName',
    ...
    'recipe_tags' => 'Oznake knjige',
    'menu_tags' => 'Oznake police',
    'tag' => 'Oznaka',
    'tags' =>  'Oznake',
    'tag_name' =>  'Ime oznake',
    ...
    'profile_not_created_recipes' => ':userName ni objavil nobene knjige',
    'profile_not_created_menus' => ':userName ni izdelal nobene knjižne police',
