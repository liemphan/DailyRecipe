...
return [
    ...
    'recently_created_recipes' => 'Recent aangemaakte boeken',
    'recently_created_menus' => 'Recent aangemaakte boekenplanken',
    ...
    'menu' => 'Boekenplank',
    'menus' => 'Boekenplanken',
    'x_menus' => ':count Boekenplank|:count Boekenplanken',
    'menus_long' => 'Boekenplanken',
    'menus_empty' => 'Er zijn geen boekenplanken aangemaakt',
    'menus_create' => 'Nieuwe boekenplank maken',
    'menus_popular' => 'Populaire boekenplanken',
    'menus_new' => 'Nieuwe boekenplanken',
    'menus_new_action' => 'Nieuwe boekenplank',
    'menus_popular_empty' => 'De meest populaire boekenplanken worden hier weergegeven.',
    'menus_new_empty' => 'De meest recent aangemaakt boekenplanken worden hier weergeven.',
    'menus_save' => 'Boekenplank opslaan',
    'menus_recipes' => 'Boeken op deze plank',
    'menus_add_recipes' => 'Voeg boeken toe aan deze plank',
    'menus_drag_recipes' => 'Sleep boeken hiernaartoe om deze toe te voegen aan deze plank',
    'menus_empty_contents' => 'Er zijn geen boeken aan deze plank toegekend',
    'menus_edit_and_assign' => 'Bewerk boekenplank om boeken toe te kennen.',
    'menus_edit_named' => 'Bewerk boekenplank :name',
    'menus_edit' => 'Bewerk boekenplank',
    'menus_delete' => 'Verwijder boekenplank',
    'menus_delete_named' => 'Verwijder boekenplank :name',
    'menus_delete_explain' => "Deze actie verwijdert de boekenplank met naam ':name'. De boeken op deze plank worden niet verwijderd.",
    'menus_delete_confirmation' => 'Weet je zeker dat je deze boekenplank wilt verwijderen?',
    'menus_permissions' => 'Boekenplank permissies',
    'menus_permissions_updated' => 'Boekenplank permissies opgeslagen',
    'menus_permissions_active' => 'Boekenplank permissies actief',
    'menus_permissions_cascade_warning' => 'Machtigingen op boekenplanken zijn niet automatisch een cascade om boeken te bevatten. Dit komt omdat een boek in meerdere schappen kan bestaan. Machtigingen kunnen echter worden gekopieerd naar subboeken door gebruik te maken van onderstaande optie.',
    'menus_copy_permissions_to_recipes' => 'Kopieer permissies naar boeken',
    'menus_copy_permissions' => 'Kopieer permissies',
    'menus_copy_permissions_explain' => 'Met deze actie worden de permissies van deze boekenplank gekopieërd naar alle boeken op de plank. Voordat deze actie wordt uitgevoerd, zorg dat de wijzigingen in de permissies van deze boekenplank zijn opgeslagen.',
    'menus_copy_permission_success' => 'Boekenplank permissies gekopieërd naar :count boeken',

    // Books
    'recipe' => 'Boek',
    'recipes' => 'Boeken',
    'x_recipes' => ':count Boek|:count Boeken',
    'recipes_empty' => 'Er zijn geen boeken aangemaakt',
    'recipes_popular' => 'Populaire boeken',
    'recipes_recent' => 'Recente boeken',
    'recipes_new' => 'Nieuwe boeken',
    'recipes_new_action' => 'Nieuw boek',
    'recipes_popular_empty' => 'De meest populaire boeken worden hier weergegeven.',
    'recipes_new_empty' => 'De meest recent aangemaakte boeken verschijnen hier.',
    'recipes_create' => 'Nieuw boek maken',
    'recipes_delete' => 'Boek verwijderen',
    'recipes_delete_named' => 'Verwijder boek :recipeName',
    'recipes_delete_explain' => 'Deze actie verwijdert het boek \':recipeName\', Alle pagina\'s en hoofdstukken worden verwijderd.',
    'recipes_delete_confirmation' => 'Weet je zeker dat je dit boek wilt verwijderen?',
    'recipes_edit' => 'Boek bewerken',
    'recipes_edit_named' => 'Bewerk boek :recipeName',
    'recipes_form_recipe_name' => 'Boek naam',
    'recipes_save' => 'Boek opslaan',
    'recipes_permissions' => 'Boek permissies',
    'recipes_permissions_updated' => 'Boek permissies opgeslagen',
    'recipes_empty_contents' => 'Er zijn nog geen hoofdstukken en pagina\'s voor dit boek gemaakt.',
    'recipes_empty_create_page' => 'Nieuwe pagina maken',
    'recipes_empty_sort_current_recipe' => 'Boek sorteren',
    'recipes_empty_add_chapter' => 'Hoofdstuk toevoegen',
    'recipes_permissions_active' => 'Boek permissies actief',
    'recipes_search_this' => 'Zoeken in dit boek',
    'recipes_navigation' => 'Boek navigatie',
    'recipes_sort' => 'Inhoud van het boek sorteren',
    'recipes_sort_named' => 'Sorteer boek :recipeName',
    'recipes_sort_name' => 'Sorteren op naam',
    'recipes_sort_created' => 'Sorteren op datum van aanmaken',
    'recipes_sort_updated' => 'Sorteren op datum van bijgewerkt',
    'recipes_sort_chapters_first' => 'Hoofdstukken eerst',
    'recipes_sort_chapters_last' => 'Hoofdstukken laatst',
    'recipes_sort_show_other' => 'Bekijk andere boeken',
    'recipes_sort_save' => 'Nieuwe volgorde opslaan',
    ...
    'chapter_move_success' => 'Hoofdstuk verplaatst naar :recipeName',
    ...
    'recipe_tags' => 'Labels van boeken',
    'menu_tags' => 'Labels van boekenplanken',
    'tag' => 'Label',
    'tags' =>  'Labels',
    'tag_name' =>  'Naam label',
    ...
    'profile_not_created_recipes' => ':userName heeft geen boeken gemaakt',
    'profile_not_created_menus' => ':userName heeft nog geen boekenplanken gemaakt',
