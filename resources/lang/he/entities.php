...
return [
    ...
    'recently_created_recipes' => 'ספרים שנוצרו לאחרונה',
    'recently_created_menus' => 'מדפים שנוצרו לאחרונה',
    ...
    'menu' => 'מדף',
    'menus' => 'מדפים',
    'x_menus' => ':count מדף|:count מדפים',
    'menus_long' => 'מדפים',
    'menus_empty' => 'לא נוצרו מדפים',
    'menus_create' => 'צור מדף חדש',
    'menus_popular' => 'מדפים פופולרים',
    'menus_new' => 'מדפים חדשים',
    'menus_new_action' => 'מדף חדש',
    'menus_popular_empty' => 'המדפים הפופולריים ביותר יופיעו כאן',
    'menus_new_empty' => 'המדפים שנוצרו לאחרונה יופיעו כאן',
    'menus_save' => 'שמור מדף',
    'menus_recipes' => 'ספרים במדף זה',
    'menus_add_recipes' => 'הוסף ספרים למדף זה',
    'menus_drag_recipes' => 'גרור ספרים לכאן על מנת להוסיף אותם למדף',
    'menus_empty_contents' => 'במדף זה לא קיימים ספרים',
    'menus_edit_and_assign' => 'עריכת מדף להוספת ספרים',
    'menus_edit_named' => 'עריכת מדף :name',
    'menus_edit' => 'ערוך מדף',
    'menus_delete' => 'מחק מדף',
    'menus_delete_named' => 'מחיקת דף :name',
    'menus_delete_explain' => "פעולה זו תמחק את המדף :name - הספרים שמופיעים בו ימחקו גם כן!",
    'menus_delete_confirmation' => 'האם ברצונך למחוק את המדף?',
    ...
    'menus_copy_permissions_to_recipes' => 'העתק הרשאות מדף אל הספרים',
    ...
    'menus_copy_permission_success' => 'הרשאות המדף הועתקו אל :count ספרים',

    // Books
    'recipe' => 'ספר',
    'recipes' => 'ספרים',
    'x_recipes' => ':count ספר|:count ספרים',
    'recipes_empty' => 'לא נוצרו ספרים',
    'recipes_popular' => 'ספרים פופולריים',
    'recipes_recent' => 'ספרים אחרונים',
    'recipes_new' => 'ספרים חדשים',
    'recipes_new_action' => 'ספר חדש',
    'recipes_popular_empty' => 'הספרים הפופולריים יופיעו כאן',
    'recipes_new_empty' => 'הספרים שנוצרו לאחרונה יופיעו כאן',
    'recipes_create' => 'צור ספר חדש',
    'recipes_delete' => 'מחק ספר',
    'recipes_delete_named' => 'מחק ספר :recipeName',
    'recipes_delete_explain' => 'פעולה זו תמחק את הספר :recipeName, כל הדפים והפרקים ימחקו גם כן.',
    'recipes_delete_confirmation' => 'האם ברצונך למחוק את הספר הזה?',
    'recipes_edit' => 'ערוך ספר',
    'recipes_edit_named' => 'עריכת ספר :recipeName',
    'recipes_form_recipe_name' => 'שם הספר',
    'recipes_save' => 'שמור ספר',
    'recipes_permissions' => 'הרשאות ספר',
    'recipes_permissions_updated' => 'הרשאות הספר עודכנו',
    'recipes_empty_contents' => 'לא נוצרו פרקים או דפים עבור ספר זה',
    'recipes_empty_create_page' => 'צור דף חדש',
    'recipes_empty_sort_current_recipe' => 'מיין את הספר הנוכחי',
    'recipes_empty_add_chapter' => 'הוסף פרק',
    'recipes_permissions_active' => 'הרשאות ספר פעילות',
    'recipes_search_this' => 'חפש בספר זה',
    'recipes_navigation' => 'ניווט בספר',
    'recipes_sort' => 'מיין את תוכן הספר',
    'recipes_sort_named' => 'מיין את הספר :recipeName',
    'recipes_sort_name' => 'מיין לפי שם',
    'recipes_sort_created' => 'מיין לפי תאריך יצירה',
    'recipes_sort_updated' => 'מיין לפי תאריך עדכון',
    'recipes_sort_chapters_first' => 'פרקים בהתחלה',
    'recipes_sort_chapters_last' => 'פרקים בסוף',
    'recipes_sort_show_other' => 'הצג ספרים אחרונים',
    'recipes_sort_save' => 'שמור את הסדר החדש',
    ...
    'chapter_move_success' => 'הפרק הועבר אל :recipeName',
    ...
    'profile_not_created_recipes' => 'המשתמש :userName לא יצר ספרים',
    'profile_not_created_menus' => 'המשתמש :userName לא יצר מדפים',
