...
return [
    ...
    'recently_created_recipes' => 'Nyligt oprettede bøger',
    'recently_created_menus' => 'Nyligt oprettede reoler',
    ...
    'menu' => 'Reol',
    'menus' => 'Reoler',
    'x_menus' => ':count reol|:count reoler',
    'menus_long' => 'Bogreoler',
    'menus_empty' => 'Ingen reoler er blevet oprettet',
    'menus_create' => 'Opret ny reol',
    'menus_popular' => 'Populære reoler',
    'menus_new' => 'Nye reoler',
    'menus_new_action' => 'Ny reol',
    'menus_popular_empty' => 'De mest populære reoler vil blive vist her.',
    'menus_new_empty' => 'De nyeste reoler vil blive vist her.',
    'menus_save' => 'Gem reol',
    'menus_recipes' => 'Bøger på denne reol',
    'menus_add_recipes' => 'Tilføj bøger til denne reol',
    'menus_drag_recipes' => 'Træk bog her for at tilføje dem til denne reol',
    'menus_empty_contents' => 'Denne reol har ingen bøger tilknyttet til den',
    'menus_edit_and_assign' => 'Rediger reol for at tilføje bøger',
    'menus_edit_named' => 'Rediger reol :name',
    'menus_edit' => 'Rediger reol',
    'menus_delete' => 'Slet reol',
    'menus_delete_named' => 'Slet bogreol :name',
    'menus_delete_explain' => "Dette vil slette bogreolen med navn ':name'. Bøger heri vil ikke blive slettet.",
    'menus_delete_confirmation' => 'Er du sikker på at du vil slette denne bogreol?',
    'menus_permissions' => 'Reoltilladelser',
    'menus_permissions_updated' => 'Reoltilladelser opdateret',
    'menus_permissions_active' => 'Aktive reoltilladelser',
    'menus_permissions_cascade_warning' => 'Tilladelser på reoler nedarves ikke automatisk til indeholdte bøger. Dette skyldes, at en bog kan eksistere på flere hylder. Tilladelser kan dog kopieres ned til underliggende bøger ved hjælp af muligheden, der findes nedenfor.',
    'menus_copy_permissions_to_recipes' => 'Kopier tilladelser til bøger',
    'menus_copy_permissions' => 'Kopier tilladelser',
    'menus_copy_permissions_explain' => 'Dette vil anvende de aktuelle tilladelsesindstillinger på denne boghylde på alle bøger indeholdt i. Før aktivering skal du sikre dig, at ændringer i tilladelserne til denne boghylde er blevet gemt.',
    'menus_copy_permission_success' => 'Reolstilladelser kopieret til :count bøger',

    // Books
    'recipe' => 'Bog',
    'recipes' => 'Bøger',
    'x_recipes' => ':count bog|:count bøger',
    'recipes_empty' => 'Ingen bøger er blevet oprettet',
    'recipes_popular' => 'Populære bøger',
    'recipes_recent' => 'Nylige bøger',
    'recipes_new' => 'Nye bøger',
    'recipes_new_action' => 'Ny bog',
    'recipes_popular_empty' => 'De mest populære bøger vil blive vist her.',
    'recipes_new_empty' => 'De nyeste boger vil blive vist her.',
    'recipes_create' => 'Lav en ny bog',
    'recipes_delete' => 'Slet bog',
    'recipes_delete_named' => 'Slet bog :recipeName',
    'recipes_delete_explain' => 'Dette vil slette bogen ved navn \':recipeName\'. Alle sider og kapitler vil blive slettet.',
    'recipes_delete_confirmation' => 'Er du sikker på at du vil slette denne bog?',
    'recipes_edit' => 'Rediger bog',
    'recipes_edit_named' => 'Rediger bog :recipeName',
    'recipes_form_recipe_name' => 'Bognavn',
    'recipes_save' => 'Gem bog',
    'recipes_permissions' => 'Bogtilladelser',
    'recipes_permissions_updated' => 'Bogtilladelser opdateret',
    'recipes_empty_contents' => 'Ingen sider eller kapitler er blevet oprettet i denne bog.',
    'recipes_empty_create_page' => 'Opret en ny side',
    'recipes_empty_sort_current_recipe' => 'Sortér denne bog',
    'recipes_empty_add_chapter' => 'Tilføj et kapitel',
    'recipes_permissions_active' => 'Aktive bogtilladelser',
    'recipes_search_this' => 'Søg i denne bog',
    'recipes_navigation' => 'Bognavigation',
    'recipes_sort' => 'Sorter bogindhold',
    'recipes_sort_named' => 'Sorter bog :recipeName',
    'recipes_sort_name' => 'Sortér efter navn',
    'recipes_sort_created' => 'Sortér efter oprettelsesdato',
    'recipes_sort_updated' => 'Sortér efter opdateringsdato',
    'recipes_sort_chapters_first' => 'Kapitler først',
    'recipes_sort_chapters_last' => 'Kapitler sidst',
    'recipes_sort_show_other' => 'Vis andre bøger',
    'recipes_sort_save' => 'Gem ny ordre',
    ...
    'chapter_move_success' => 'Kapitel flyttet til :recipeName',
    ...
    'profile_not_created_recipes' => ':userName har ikke oprettet nogle bøger',
    'profile_not_created_menus' => ':userName har ikke oprettet nogle reoler',
