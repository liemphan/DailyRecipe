...
class RolesTest extends TestCase
{
    ...
    public function test_bookshelves_create_all_permissions()
    {
        ...
        ])->assertRedirect('/menus/test-shelf');
    }

    public function test_bookshelves_edit_own_permission()
    {
        /** @var Recipemenus $otherShelf */
        $otherShelf = Recipemenus::query()->first();
    ...
    public function test_bookshelves_delete_own_permission()
    {
        ...
        $this->delete($ownShelf->getUrl())->assertRedirect('/menus');
        $this->get('/menus')->assertDontSee($ownShelf->name);
    }
    ...
    public function test_bookshelves_delete_all_permission()
    {
        ...
        $this->delete($otherShelf->getUrl())->assertRedirect('/menus');
        $this->get('/menus')->assertDontSee($otherShelf->name);
    }
