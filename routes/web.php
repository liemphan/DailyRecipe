...
Route::middleware('auth')->group(function () {
    ...
    // Recipe Creation
    Route::get('/menus/{menuSlug}/create-book', [RecipeController::class, 'create']);
    Route::post('/menus/{menuSlug}/create-book', [RecipeController::class, 'store']);
    Route::get('/create-book', [RecipeController::class, 'create']);
    ...
    Route::get('/recipes/{bookSlug}/permissions', [RecipeController::class, 'showPermissions']);
    Route::put('/recipes/{bookSlug}/permissions', [RecipeController::class, 'permissions']);
    Route::get('/recipes/{slug}/delete', [RecipeController::class, 'showDelete']);
    Route::get('/recipes/{bookSlug}/sort', [RecipeSortController::class, 'show']);
    Route::put('/recipes/{bookSlug}/sort', [RecipeSortController::class, 'update']);
    Route::get('/recipes/{bookSlug}/export/html', [RecipeExportController::class, 'html']);
    Route::get('/recipes/{bookSlug}/export/pdf', [RecipeExportController::class, 'pdf']);
    Route::get('/recipes/{bookSlug}/export/markdown', [RecipeExportController::class, 'markdown']);
    Route::get('/recipes/{bookSlug}/export/zip', [RecipeExportController::class, 'zip']);
    Route::get('/recipes/{bookSlug}/export/plaintext', [RecipeExportController::class, 'plainText']);
