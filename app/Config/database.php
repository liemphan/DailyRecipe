...
return [
    ...
    // Many of those shown here are unsupported by DailyRecipe.
    'connections' => [
        ...
        'mysql_testing' => [
            ...
            'host' => '127.0.0.1',
            'database' => 'dailyrecipe-test',
            'username' => env('MYSQL_USER', 'dailyrecipe-test'),
            'password' => env('MYSQL_PASSWORD', 'dailyrecipe-test'),
            'port' => $mysql_port,
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
